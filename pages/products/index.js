...
export default function Products({ products }) {
  ...
  return (
    <Layout className="">
      <Head title={"All phones"} />

      <h1 className="text-center text-4xl font-bold py-10">Phones</h1>
          ...
          <div className="w-6/12">
            ...
            <div className="flex flex-col mt-5">
              <Link href="/products/Apple">
                <a className="mt-5 mb-2 cursor-pointer">Apple</a>
              </Link>
              <Link href="/products/Samsung">
                <a className="my-2 cursor-pointer">Samsung</a>
              </Link>
              <Link href="/products/Xiaomi">
                <a className="my-2 cursor-pointer">Xiaomi</a>
              </Link>
              <Link href="/products/Sony">
                <a className="my-2 cursor-pointer">Sony</a>
              </Link>
              <Link href="/products/Nokia">
                <a className="my-2 cursor-pointer">Nokia</a>
              </Link>
              <Link href="/products/">
                <a
                  className={
